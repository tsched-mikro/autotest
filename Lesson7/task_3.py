...
class PublicTransport:
    """ Типовой класс для создания транспорта """
...
class Bus(PublicTransport):
    ...
    @property
    def park(self):
        """ Вывод парка приписки автобуса """
        return self.__park

    @park.setter
    def park(self, park):
        """ Ввод парка приписки автобуса с проверкой парка приписки """
        if 1000 <= park <= 9999:
            self.__park = park
        else:
